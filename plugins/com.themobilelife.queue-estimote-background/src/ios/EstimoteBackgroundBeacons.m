...
@interface EstimoteBackgroundBeacons () <ESTBeaconManagerDelegate,ESTBeaconDelegate>
...
@implementation EstimoteBackgroundBeacons

- (EstimoteBackgroundBeacons*)pluginInitialize
{
...
{
    //    NSLog(@"didDiscoverBeacons count = %d", beacons.count);
    //    NSLog(@"didDiscoverBeacons %@", beacons);
    
    NSArray* oldBeacons = self.beacons;
...
-(void)beaconManager:(ESTBeaconManager *)manager
     didRangeBeacons:(NSArray *)beacons
            inRegion:(ESTBeaconRegion *)region
{
    NSLog(@"didRangeBeacons count = %d", beacons.count);
    self.beacons = beacons;
}
